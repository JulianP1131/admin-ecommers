...
export default function News() {
    ...
    return (
        <Layout>
            <Link className="bg-rojoM mt-4 text-white rounded-md py-1 px-2" href={'/news/new'}>
                Agregar una noticia
            </Link>
            <table className="basic mt-5">
                <thead>
                    <tr>
                        <td className="text-negro">Titulo de la noticia</td>
                        <td></td>
                    </tr>
                </thead>
                <tbody>
                    {news.map(notice => (
                        <tr key={notice._id}>
                            ...
                            <td className="text-center">
                                <Link className="mr-5 inline-flex items-center" href={'/news/edit/' + notice._id}>
                                ...
                                <Link className="ml-5 inline-flex items-center" href={'/news/delete/' + notice._id}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} 
                                    stroke="currentColor" className="w-4 h-4 mr-1 ml-1">
