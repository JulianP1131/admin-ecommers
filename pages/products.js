                    ...
                    {products.map(product => (
                        <tr key={product._id}>
                            ...
                            <td className="text-center">
                                <Link className="mr-5 inline-flex items-center" href={'/products/edit/' + product._id}>
                                ...
                                <Link className="ml-5 inline-flex items-center" href={'/products/delete/' + product._id}>
